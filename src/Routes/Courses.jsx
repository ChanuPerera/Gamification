                                ...
                                >
                                    ...
                                    <div className="flex flex-row w-full justify-between items-center">
                                        <div className="course-img sm:w-[180px] lg:w-[300px] sm:h-[180px] relative w-1/4" >
                                            <img src={course.CourseMainImg} alt="" className="object-cover w-full h-full rounded-md" />
                                        </div>
                                        <div className="p-2 flex flex-col w-3/4">
                                            <h2 className="text-white sm:text-[1.8rem] font-semibold ">{course.CourseTitle}</h2>
                                            ...
                                            <div className="w-full pt-5 border-collapse border-t-[1px] border-gray-300 border-opacity-40 flex flex-row space-x-3 lg:justify-start">
                                                {course.Courses.map((details, index) => (
                                    ...
                                    {isMaterialsVisible && (
                                        <div className="course-metarials p-2 flex flex-col w-full">
                                            <div className="flex flex-col w-full justify-between">
                                                <h2 className="text-white sm:text-[1.2rem] font-semibold">Lesson {currentIndex + 1}</h2>
                                            </div>
